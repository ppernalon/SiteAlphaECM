export default
{
    Assos:{
        ...
        AUMONERIE: {
            ...
            Message: "Tu es Catholique ? Tu te poses des questions ?\n" +
                "Tu ne crois pas en Dieu ? Peu importe !\n" +
                "L’aumônerie t’accueille tous les vendredis\n" +
                "soirs dans la chapelle de Château-Gombert (un\n" +
                "village juste au-dessus de Centrale). Un temps\n" +
                "d’échange autour de la parole de Dieu accompagné\n" +
                "par notre aumônier, et suivi par des pizzas ! Nous\n" +
                "invitons régulièrement des communautés, des associations et des prêtres\n" +
                "à venir témoigner et partager avec nous. Prière, chant, débat, animation de\n" +
